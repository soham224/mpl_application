...
import {
    MyResultTable
} from "../../Admin/modules/MyResults/components/DeployedRTSPJobs/MyResultTable/my-result-table/MyResultTable";
...
function ResultPage(props) {
    ...
    function applyFilter() {
        if (!selectedLoctionArray.length) {
            warningToast("Please Select Location");
            return;
        }
        if (!selctedCameraId.length) {
            warningToast("Please Select Camera");
            return;
        }
        if (!selectedLabelArray.length) {
