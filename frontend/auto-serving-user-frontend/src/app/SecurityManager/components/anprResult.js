...
import {ViewImageModal} from "../../Admin/modules/ANPRManager/ViewImageModal";
...
import * as actions from "../../Admin/modules/ANPRManager/_redux/AnprManagerAction";
...
import {speedFilterOptions} from "../../Admin/modules/ANPRManager/ViewANPR";
        ...
        <>
            <Card className="example example-compact" style={{minHeight: "150px", overflow: "visible"}}>
                <CardBody style={{padding: "10px 10px"}}>
                    <Row>
                        <Col xl={10} xs={12} md={10} className={'d-flex align-items-center'}>
                                <h3>ANPR Violation</h3>
                        </Col>
                        <Col xl={2} md={2} xs={12}>
                            <div className="">
                                <input
                                    type="text"
                                    name="searchText"
                                    placeholder={"Search For Number Palte"}
                    ...
                    <Row className="space">
                        ...
                        <Col xl={2} xs={12} md={12} sm={12}>
                            <div className={"d-flex justify-content-end mr-2 mt-5"}>
                                <Button
