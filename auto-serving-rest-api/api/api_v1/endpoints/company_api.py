...
def add_company(
    ...
    company_details.created_date = datetime.datetime.utcnow().replace(microsecond=0)
    company_details.updated_date = datetime.datetime.utcnow().replace(microsecond=0)
